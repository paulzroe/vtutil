...
class VTUtilsV3:
    ...
    LIVE_HUNT_URL = vtc.BASE_URL + 'api/v3/intelligence/hunting_notifications/'
    ...
    def getfileRelationship3(self, hash, relationships):
        # relationship is comma separeted
        # contacted_domains
        # contacted_ips
        # contacted_urls
        # execution_parents
    ...
    def getIPRelationship3(self, ipv4, relationship, limit=10):
    ...
    def getDomainReport3(self, domain):
        headers = {'x-apikey': self.APIKEY}
    ...
    def getDomainRelationship3(self, domain, relationship, limit=10):
        # relationship variable could include the following:
        # communicating_files
        # downloaded_files
        # graphs
    ...
    def search3(self, search_string=None, limit=10):
        params = {'limit': limit,
                  'query': search_string}
        headers = {'x-apikey': self.APIKEY}
    ...
    def getfileSubmissions3(self, hash):
        headers = {'x-apikey': self.APIKEY}
        ...
        if vtResponse is not None:
            if vtResponse.get('response_code') == 1:
                ...
                for sha256 in hashes:
                    vtFileReport = VTUtilsV3.getfileReport3(sha256)
                    try:
...
class VTUtilsV2:
    ...
    def normalize_malware_names_step1(self, malwarenames):
    ...
    def normalize_malware_names_step2(self, names):
        # sort Replace Map
